...
import org.modelio.soundUML.impl.TextToSpeech;
...
public class DescribeSelectedElementCommand extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selectedElements, IModule module) {
		...
		// Nao da para criar ficheiro através de um URI num ficheiro jar, mas dá para
		// passar o input stream directamente e tocar
		...
		// module.getModuleContext().getModelioServices().getPickingService();
		// IPickingClient pickingClient = null;
		// IPickingSession pickingSession =
		// pickingService.startPickingSession(pickingClient);

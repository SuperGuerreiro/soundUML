...
public class FindElementInDiagramCommand extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
       ...
       //Iterar todos os diagramas existentes (posso ter dentro deste projecto um class diagram, um state machine, etc...)
       for(AbstractDiagram d : elements) {
    	   ...
    	   //Iterar esses elementos deste diagrama e encontra aquele com o nome igual ao que passámos como input
       ...
       if(!elementFound) {
		   MessageDialog.openInformation(null, "No Element was found", "Sorry, the element with the name " + inputName + " was not found.");
	   }     

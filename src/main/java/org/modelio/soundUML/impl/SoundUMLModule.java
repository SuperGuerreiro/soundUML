 ...
 * 
 */
public class SoundUMLModule extends AbstractJavaModule {

	private SoundUMLPeerModule peerModule = null;

	private SoundUMLLifeCycleHandler lifeCycleHandler = null;
	
	private static SoundUMLModule instance;

	public static SoundUMLModule getInstance() {
		return instance;
	}

	@Override
	public SoundUMLPeerModule getPeerModule() {
	 ...
	 */
	public SoundUMLModule(IModuleContext moduleContext) {
		super(moduleContext);

		SoundUMLModule.instance = this;

		this.lifeCycleHandler = new SoundUMLLifeCycleHandler(this);
		this.peerModule = new SoundUMLPeerModule(this, moduleContext.getPeerConfiguration());
	}

...
import org.modelio.soundUML.api.ISoundUMLPeerModule;
 ...
 *
 */
public class SoundUMLPeerModule implements ISoundUMLPeerModule {
    private SoundUMLModule module;
	
    private IModuleAPIConfiguration peerConfiguration;
    
	public SoundUMLPeerModule(SoundUMLModule statModuleModule, IModuleAPIConfiguration peerConfiguration) {
		super();
